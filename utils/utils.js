...
const getCinemasShowingMovie = () => {
  console.log(currentlyShowingMovies);
  return currentlyShowingMovies.map(async m => {
...
// let currentlyShowingMovies;
// let cinemasShowingMovie;
// getCurrentlyShowingMovies()
//   .then(result => (currentlyShowingMovies = result))
//   .then(() => {
//     cinemasShowingMovie = getCinemasShowingMovie();
//   });

module.exports = (async () => {
  const currentlyShowingMovies = await getCurrentlyShowingMovies();
  const cinemasShowingMovie = await getCinemasShowingMovie();
...
//const imdbData = getImdbDataForMovie();
//const cinemasShowingMovie = getCinemasShowingMovie();
